 ...
 *
 * The site pulls Marcellus, Merriweather and VT323 from the Google Fonts CDN:
 * Marcellus and VT323 through @imports in `styles/globals.css`, Merriweather
 * through a <link> in `pages/_document.js` (that one's URL names two axes, which
 * `next build` will not carry through an @import — see the comment at the top
 * of globals.css). Both files are scanned below, so a family stays cached
